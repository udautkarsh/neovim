  ...
  opts = {
    ...
    dashboard = {
      ...
      sections = {
        ...
        { pane = 2, icon = " ", title = "Recent Files", section = "recent_files", indent = 3, padding = 2, limit = 12 },
        { pane = 2, icon = " ", title = "Projects", section = "projects", indent = 3, padding = 2 , limit = 15},
        { section = "startup" },
      },
    },
